 ...
 */
const SERVERS = {
  "GET /api/[...remult]": (params: { remult: (string | number)[] }) => {
    return `/api/${params.remult?.join('/')}`
  },
  "POST /api/[...remult]": (params: { remult: (string | number)[] }) => {
    return `/api/${params.remult?.join('/')}`
  },
  "PUT /api/[...remult]": (params: { remult: (string | number)[] }) => {
    return `/api/${params.remult?.join('/')}`
  },
  "DELETE /api/[...remult]": (params: { remult: (string | number)[] }) => {
    return `/api/${params.remult?.join('/')}`
  }
}
...
export type KIT_ROUTES = {
  ...
  LINKS: { 'firstly_sign_in': never, 'github': 'owner' | 'repo', 'remult_admin': never }
